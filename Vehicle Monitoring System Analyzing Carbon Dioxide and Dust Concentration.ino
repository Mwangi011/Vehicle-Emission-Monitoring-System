...
void setup()
{
  ...
  s3.end_mcdl();
  s3.end_acdl();
  Serial.println("START S300I2C & PPD42ns");  
}
...
void loop()
{
  ...
  if ((millis()-starttime) >= sampletime_ms) //if the sampel time = = 30s
 {
  ...
  String str="GET https://api.thingspeak.com/update?api_key=F6O1KABJHLY38DHA&field1=" + String(co2) + "&field2=" + String(concentration);
  Serial.println(str);
